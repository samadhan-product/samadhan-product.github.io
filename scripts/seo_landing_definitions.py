...
<p>I reply to serious inquiries within one business day.</p></section>""",
    ...
    services = [
        (
            "services/ai-product-strategy/index.html",
            "/services/ai-product-strategy/",
            "AI Product Strategy Consulting",
            "AI product strategy—use-case portfolios, build vs buy, model selection, eval design, and executive roadmaps.",
            "AI Product Strategy",
            "<p>Define which AI investments deserve capital: workflow leverage, data readiness, risk, and unit economics—before engineering sprint zero.</p>",
        ),
        (
            "services/ai-agents-workflow-automation/index.html",
            "/services/ai-agents-workflow-automation/",
            "AI Agents & Workflow Automation",
            "Design governed agentic workflows—tools, HITL, observability, and cost per run.",
            "AI Agents & Workflow Automation",
            "<p>Agent PRDs, permission models, stopping conditions, and production guardrails for operations teams.</p>",
        ),
        (
            "services/rag-knowledge-systems/index.html",
            "/services/rag-knowledge-systems/",
            "RAG & Knowledge Systems Consulting",
            "RAG architecture, retrieval quality, grounding, and evals for enterprise knowledge products.",
            "RAG & Knowledge Systems",
            "<p>Chunking, embeddings, hybrid search, freshness, and hallucination controls tied to business metrics.</p>",
        ),
        (
            "services/healthcare-insurance-ai/index.html",
            "/services/healthcare-insurance-ai/",
            "Healthcare & Insurance AI Automation",
            "Healthcare and insurance AI—claims, pre-auth, documents, and TPA operations.",
            "Healthcare & Insurance AI Automation",
            "<p>Workflow-first automation with compliance-aware human oversight and systems-of-record integration.</p>",
        ),
        (
            "services/product-operating-model/index.html",
            "/services/product-operating-model/",
            "Product Operating Model Design",
            "AI product operating models—intake, evals, model memos, release governance, and portfolio metrics.",
            "Product Operating Model Design",
            "<p>Templates and rituals so teams scale AI features without repeating the same failures.</p>",
        ),
        (
            "services/product-leadership-advisory/index.html",
            "/services/product-leadership-advisory/",
            "Product Leadership Advisory",
            "Executive advisory for product heads building AI-native teams and portfolios.",
            "Product Leadership Advisory",
            "<p>Coaching for product executives on hiring, prioritization, and stakeholder alignment in AI programs.</p>",
        ),
    ]
    for file_path, path, title, desc, h1, body_p in services:
        body = f'<section class="cg-article-section">{body_p}<p><a href="/case-studies/">Case studies</a> · <a href="/insights/">Insights</a> · <a href="/work-with-me/">Work with me</a></p></section>'
        add(
            file_path,
            path,
            title + " | Samadhan Mishra",
            desc,
            h1,
            body,
            "services",
            [("Home", "/"), ("Services", "/ai-product-management-consultant/"), (h1, path)],
            service_schema(title, desc, SITE + path),
            faqs=shared_faqs[:4],
            geo=shared_geo[:4],
        )
